...
module.exports = function(registry) {
  ...
  async function tryReplicate(sourceModel, targetModel, since, options) {
    ...
    // Only define minimal Conflict if it doesn't exist
    if (!Change.Conflict) {
      ...
      Change.Conflict.prototype.resolveUsingSource = async function() {
        if (this.sourceModel && this.sourceModel._allowResolve) {
          await this.resolve()
          return
        }
      ...
      Change.Conflict.prototype.resolveUsingTarget = async function() {
        if (this.targetModel && this.targetModel._allowResolve) {
      ...
      // Add the resolve method that was missing
      ...
      // Add models method that was missing
