...
module.exports = function(registry) {
  ...
  PersistedModel.enableChangeTracking = function() {
    ...
    async function rectifyOnSave(ctx) {
      ...
      try {
        // For all operations, use rectifyAllChanges to ensure comprehensive change recording
        // This is more aligned with the original implementation and handles edge cases better
