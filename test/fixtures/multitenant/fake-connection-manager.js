...
//
// Kept as a fixture so loopback's test suite has no dependency on the
// real package or on MongoDB. Single-flight creation per tenant matches
// production behavior (PoolManager.poolCreationLocks).
